...
export class ModalProductoComponent implements OnInit{
  ...
  formularioProducto:FormGroup; //Formulario que envía datos del objeto actual  
  tituloAccion: string = "Agregar";//Titulo de la tarjeta
  botonAccion: string = "Guardar";//Texto del boton
  listaCategorias: Categoria[] = [];//Lista de categorias, luego se rellena con un Get del CategoriaService

  constructor(
    private modalActual: MatDialogRef<ModalProductoComponent>,//Este componente va a ser un modal
    @Inject(MAT_DIALOG_DATA) public datosProducto: Producto,//asigna como datos del modal a el objeto Usuario
