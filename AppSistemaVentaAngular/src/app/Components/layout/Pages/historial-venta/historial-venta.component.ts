...
export class HistorialVentaComponent implements OnInit, AfterViewInit{
  ...
  constructor(
    ...
    //se resetean los campos luego de realizar la busqueda
  ...
  aplicarFiltroTabla(event: Event){
    ...
    this.datosListaVenta.filter = filterValue.trim().toLocaleLowerCase();//se filtra segun el valor, sacándole los espacios y en minúsculas
  }
