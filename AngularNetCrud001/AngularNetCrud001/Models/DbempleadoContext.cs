...
namespace AngularNetCrud001.Models;
...
public partial class DbempleadoContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDepartamento).HasName("PK__Departam__787A433D72E8BD6D");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__Empleado__CE6D8B9EF1E69197");
