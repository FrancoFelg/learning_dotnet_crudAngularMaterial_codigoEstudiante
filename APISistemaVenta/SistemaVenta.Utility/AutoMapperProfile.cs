    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile() {
            ...
            CreateMap<UsuarioDTO, Usuario>()
                .ForMember(destino =>
                destino.IdRolNavigation, opt => opt.Ignore())
            ...
            CreateMap<Venta, VentaDTO>().ReverseMap()
                ...
                opt => opt.MapFrom(origen => origen.FechaRegistro));
            ...
            CreateMap<DetalleVentaDTO, DetalleVenta>()
                .ForMember(destino => destino.Precio, opt => opt.MapFrom(origen => Convert.ToDecimal(origen.PrecioTexto, new CultureInfo("es-AR"))))
